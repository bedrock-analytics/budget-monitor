...
```
cd existing_repo
git remote add origin https://gitlab-ce.arv.co.th/cloud_arv/subsea/x-app/x.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab-ce.arv.co.th/cloud_arv/subsea/x-app/x/-/settings/integrations)
